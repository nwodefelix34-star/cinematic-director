...
`,
  ...
  // ── KnowIt3D viral style ── used for IDEA GENERATION only ──
  // Storyboard/script handled separately by generateKnowIt below.
  knowit3d: `
CHANNEL DNA (@KnowIt3D):
Core Tone: Body science that feels personal. The viewer's own body is doing something weird RIGHT NOW.

TITLE STRUCTURE:
- Maximum 8 words. Plain English only. No medical jargon.
- Must name a specific body sensation, reaction, or silent process the viewer has experienced.
- Must create a "wait... why DOES that happen?" moment.
- Never start with "Why" alone — start with the sensation or process itself.
- No full explanations in the title. Leave the mechanism open.
- Pattern options:
  · [Relatable sensation] + [surprising implication] — "Your Heart Actually Skips a Beat When You Fall"
  · [Body process] + [unsettling twist] — "Your Liver Is Working Overtime Right Now"
  · [Silent body event] + [scale reveal] — "Your Cells Replace Themselves Every 7 Years"

NICHE PILLARS (rotate across these categories):
- Body Mystery: everyday sensations with surprising biology (goosebumps, eye twitches, ear ringing, joint cracks)
- Silent Killer: invisible internal processes people ignore (inflammation, blood pressure, liver stress, cortisol)
- Extreme Scenario: what your body does in wild situations (near-drowning, lightning strike, snake venom, extreme cold)
- Danger Zone: common habits silently damaging a system (dehydration, sleep debt, posture, sugar spikes)
- Story Touch: emotional body response to human experiences (heartbreak, fear, love, loss, adrenaline)

AVOID COMPLETELY:
- Generic YouTube growth topics
- Motivational content
- How-to tutorials
- Mental health advice
- Diet or fitness tips that aren't body-science based

CURIOSITY RULE:
- Viewer must instinctively touch or think about the body part mentioned within 3 seconds of reading the title.
- If a healthy adult has never experienced what the title describes, rewrite it.
`,
...
${topic && topic.trim() !== ""
  ? topic
  : channelId === "knowit3d"
    ? "Generate 10 completely original body-science topics — specific real sensations, internal processes, or extreme body reactions. Each must be something a healthy adult has personally experienced or finds immediately relatable. Rotate across: Body Mystery, Silent Killer, Extreme Scenario, Danger Zone, Story Touch."
    : "Generate completely original trending topic angles specific to this channel niche"}
